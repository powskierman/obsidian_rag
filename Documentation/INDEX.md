...
This index lists current, supported docs. Historical plans and fixes are in `Documentation/Archive/`.

## Quickstart and Setup
- Documentation/Setup/QUICKSTART.md
- Documentation/Setup/NEXT_STEPS.md
- Documentation/Setup/TESTING.md
- Documentation/Setup/COST_DECISION_GUIDE.md
- Documentation/Setup/INDEXING_SCRIPTS_GUIDE.md
- Documentation/Setup/GRAPHRAG_SETUP.md
- Documentation/Setup/API_KEY_VALIDATION_GUIDE.md
- Documentation/Setup/MAC_MINI_QUICK_START.md
- Documentation/Setup/MAC_MINI_NETWORKING_FIX.md

## System Overview and Architecture
- Documentation/SYSTEM_OVERVIEW_2025.md
- Documentation/architecture/SYSTEM_ARCHITECTURE_DIAGRAM.md
- Documentation/architecture/STREAMLIT_ARCHITECTURE.md
...
- Documentation/GRAPH_SEARCH_IMPROVEMENTS.md
...
- Documentation/Embedding/EMBEDDING_MODEL_UPDATE_GUIDE.md
- Documentation/KNOWLEDGE_GRAPH_TEST_PROMPTS.md
...
## Docker
- Documentation/Docker/DOCKER_MCP_INTEGRATION.md
- Documentation/Docker/DOCKER_GATEWAY_TROUBLESHOOTING.md
- Documentation/Docker/DOCKER_GATEWAY_CLAUDE_DESKTOP_FIX.md
- Documentation/Docker/DISABLE_DOCKER_OBSIDIAN.md
- Documentation/guides/troubleshooting/DOCKER_TROUBLESHOOTING.md

## Troubleshooting
- Documentation/TROUBLESHOOTING_QUERY.md
- Documentation/guides/troubleshooting/API_KEY_VALIDATION_GUIDE.md
- Documentation/guides/troubleshooting/CHROMADB_CORRUPTION_FIX.md
- Documentation/guides/troubleshooting/TROUBLESHOOTING_STREAMLIT_MODEL_ERROR.md
- Documentation/guides/troubleshooting/Queries.md
...
- Documentation/guides/TEST_SUITE_README.md
- Documentation/guides/PUSH_INSTRUCTIONS.md
- Documentation/guides/SLIM_REPO_GUIDE.md

## Reference
- Documentation/Reference/SERVICE_CAP_INFO.md
