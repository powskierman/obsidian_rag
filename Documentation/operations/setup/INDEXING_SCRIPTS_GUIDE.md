...
*   **Reference guide:** `Documentation/operations/setup/LIGHTRAG_PARTIAL_INDEXING_GUIDE.md`
...
### Unexpected Results on MacBook
If the MacBook is returning thin or outdated results:
...
3.  **Check Logs**:
    ...
    ```
    Verify that the LightRAG service is healthy and receiving query traffic when cascading retrieval runs.
